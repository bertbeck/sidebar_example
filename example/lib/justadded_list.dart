...
class JustAddedList extends StatelessWidget {
  JustAddedList({required this.title});
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: JustAdded(title: title),
    );
  }
}

class JustAdded extends StatefulWidget {
  JustAdded({required this.title});

  final String title;

  @override
  _JustAddedState createState() => _JustAddedState();
}

class _JustAddedState extends State<JustAdded> {
